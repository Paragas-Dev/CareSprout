<div class="sidebar">
  ...
  <div class="menu-items">
    ...
    <a class="menu-item {{ request()->routeIs('lessons.home') ? 'active' : '' }}" href="{{ route('lessons.home') }}">
    ...
    <a class="menu-item {{ request()->routeIs('announcement') ? 'active' : '' }}" href="{{ route('announcement') }}">
      <i class="fas fa-bullhorn"></i> Announcements
    </a>
  </div>

  <div class="bottom-menu-items">
    <a class="menu-item {{ request()->routeIs('settings') ? 'active' : '' }}" href="{{ route('settings') }}"><i class="fas fa-cog"></i> Settings</a>
    <a class="menu-item {{ request()->routeIs('lessons.archived') ? 'active' : '' }}" href="{{ route('lessons.archived') }}"><i class="fas fa-archive"></i> Archived Lessons</a>
